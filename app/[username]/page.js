    ...
    <div>
      ...
      <div className='text-center mt-5 gap-y-3'>
        ...
        <h3 className='text-gray-300'>
          let's Help {user.username} to get a cup of tea
        </h3>
      </div>
      ...
      <div className='flex flex-col lg:flex-row justify-center mt-10 gap-8 px-4'>
        ...
        <div className="make-payment bg-slate-950 opacity-75 rounded-lg h-[60vh] w-full lg:w-[40vw] p-8">
          ...
          <form className='gap-5 mt-5'>
            <input type="text" name='name' placeholder='Name' className='bg-gray-800 rounded-lg w-full p-1.5 mt-5' required />
            <input type="text" name='message' placeholder='Message' className='bg-gray-800 rounded-lg w-full p-1.5 mt-5' required />
            <input type="number" name='amount' placeholder='Amount' className='bg-gray-800 rounded-lg w-full p-1.5 mt-5' required />
          ...
          <div className='mt-5 flex flex-wrap gap-2 cursor-pointer'>
            <PaymentPage username={user.username} amount={1} />
            <PaymentPage username={user.username} amount={20} />
            <PaymentPage username={user.username} amount={30} />
            <PaymentPage username={user.username} amount={40} />
          </div>
        </div>
      </div>
    </div>
